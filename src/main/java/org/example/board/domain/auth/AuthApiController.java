...
public class AuthApiController {
    ...
    public ResponseEntity<Map<String, Boolean>> checkUserAuth(HttpServletRequest request) {
        String refreshToken = CookieUtils.getCookieValue(request, "refreshToken");

        boolean isLoggedIn = refreshToken != null && jwtService.validateToken(refreshToken);
